...
1. When might type coercion occur? How to avoid it? How would you change a `falsey` or `truthy` into a real boolean?
...
2. Describe how variable scope works. Explain how to create a closure,using a self-executing function(also called IIFE:    immediately-invoked function expression).
   +  Variable scope:
...
04. How does a client-side *MVC* or (*MVVM*) approach work? What is you preferred *MV\** framework?
* Coming soon.

05. Why do these yield different results:
...
06. Why is `0.3` not the result of the following addition? How do you work around this bug:
...
07. Describe how variable hoisting works, and how to account for it:
...
09. When would you use `*.call()`? - when would you use `*.apply()`?:
